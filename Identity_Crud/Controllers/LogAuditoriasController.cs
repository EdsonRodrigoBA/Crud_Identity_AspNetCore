...
namespace Identity_Crud.Controllers
{
    public class LogAuditoriasController : Controller
    {
        ...
        {
            return View(await _context.LogAuditorias.ToListAsync());
        }
        ...
        //public async Task<IActionResult> Create([Bind("Id,Detalhes,EmailUser")] LogAuditoria logAuditoria)
        //{
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> Edit(int id, [Bind("Id,Detalhes,EmailUser")] LogAuditoria logAuditoria)
        //{
        ...
        //{
        //    return _context.LogAuditorias.Any(e => e.Id == id);
        //}
    }
}
